        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <Button 
              variant="outline" 
              size="sm" 
              className="mb-8 bg-white/10 border-white/30 text-white hover:bg-white/20 hover:text-white"
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Why Choose <span className="text-accent">LeadConnect</span> Consultancy Services
            </h1>
